...
with gr.Blocks(title="Sidekick", theme=gr.themes.Default(primary_hue="emerald")) as ui:
    ...
    with gr.Accordion("📆 Calendar", open=False):
        ...
        cal_start       = gr.Textbox(label="Start (RFC3339)", placeholder="2025-05-20T15:00:00+02:00")
        cal_end         = gr.Textbox(label="End   (RFC3339)", placeholder="2025-05-20T16:00:00+02:00")
        ...
        cal_output      = gr.Textbox(label="Calendar Output", interactive=False, lines=10)
    ...
    list_events_btn.click(
        fn=lambda: list_upcoming_events(os.getenv("GOOGLE_CALENDAR_ID", "primary"), 10),
        outputs=cal_output
    )
